...
modDat <- readRDS("./Data_processed/CoverData/TotalTreeOnly_FIAandAIM_DataForModels_spatiallyAveraged_sf_sampledLANDFIRE.rds")
modDat %>% 
  #st_drop_geometry() %>% 
...
saveRDS(newDat, "./Data_processed/CoverData/TotalTreeOnly_FIAandAIM_DataForModels_withEcoregion_sampledLANDFIRE.rds")
# 
# newDat %>%
#   st_drop_geometry() %>%
#   ggplot() +
