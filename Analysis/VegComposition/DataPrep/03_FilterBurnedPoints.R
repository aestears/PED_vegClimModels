...
here::i_am("Analysis/VegComposition/DataPrep/03_FilterBurnedPoints.R")
...
## save data prior to removing burned area 
saveRDS(plotDat_noFireAll, file = "./Data_processed/CoverData/dataForAnalysis_FireDataPRE_fireRemoved.rds")
