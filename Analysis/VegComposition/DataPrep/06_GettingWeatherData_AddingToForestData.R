...
test5 <- 
  readRDS("./Data_processed/CoverData/TotalTreeOnly_FIAandAIM_spatiallyAverageData_intermediate_test5.rds")
...
#   filter(Year < 2024)
## save the data
saveRDS(allDat_avg, "./Data_processed/CoverData/TotalTreeOnly_FIAandAIM_DataForModels_spatiallyAveraged_sf_sampledLANDFIRE.rds")
saveRDS(st_drop_geometry(allDat_avg), "./Data_processed/CoverData/TotalTreeOnly_FIAandAIM_DataForModels_spatiallyAveraged_NoSf_sampledLANDFIRE.rds")
# 
# # 
# allDat_avg %>%
