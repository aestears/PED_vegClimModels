...
rmarkdown::render(input = "./Analysis/VegComposition/ModelFitting/02_modelFitting_testingBetaLASSO.Rmd", 
                  ...
                  output_format = "html_document", 
                  output_dir = "./Analysis/VegComposition/ModelFitting/outputHtmls/",
                  output_file = "betaLASSO_test_GrassShrub_TotalTreeCover_removeAllAnoms.html")
#forest
rmarkdown::render(input = "./Analysis/VegComposition/ModelFitting/02_modelFitting_testingBetaLASSO.Rmd", 
                  params = list(  run = FALSE,
                                  save_figs = FALSE,
                  ...
                  output_format = "html_document", 
                  output_dir = "./Analysis/VegComposition/ModelFitting/outputHtmls/",
                  output_file = "betaLASSO_test_forest_TotalTreeCover_removeAllAnoms.html")
#CONUS
rmarkdown::render(input = "./Analysis/VegComposition/ModelFitting/02_modelFitting_testingBetaLASSO.Rmd", 
                  params = list(  run =  TRUE,
                                  save_figs = FALSE,
                  ...
                  output_format = "html_document", 
                  output_dir = "./Analysis/VegComposition/ModelFitting/outputHtmls/",
                  output_file = "betaLASSO_test_CONUS_TotalTreeCover_removeAllAnoms.html")
