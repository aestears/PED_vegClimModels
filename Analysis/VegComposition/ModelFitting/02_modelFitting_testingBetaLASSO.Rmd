---
title: "02_modelFitting_testingBetaLASSO"
author: "Alice Stears"
...
```{r}
modDat_1 <- modDat_1 %>% 
mutate(response_transformed = .[[response]] + 0) 
...
"coarse"                ,"carbon"             , "AWHC"         ,     
"tmax_anom"             ,"prcp_anom"          ,  "t_warm_anom",  "t_cold_anom",  "prcp_wet_anom"           , "precp_dry_anom"    ,     
...
if (removeAllAnoms) { ## if the model parameters indicate that we don't want any anomalies... 
 ...
 ## break predictors into climate, weather, and soils 
  ...
  mod_string <- paste(response_t, "~", paste0(c(prednames_clim, prednames_soils), collapse = "+"))
