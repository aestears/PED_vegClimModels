...
modDat <- readRDS( here("Data_processed", "CoverData", "TotalTreeOnly_FIAandAIM_DataForModels_spatiallyAveraged_withSoils_noSf_sampledLANDFIRE.rds")) %>% st_drop_geometry()
```
...
saveRDS(modDat_1_s_temp, file = "./models/scaledModelInputData_yesNoTreeMod_Number1.rds")
...
if (run == TRUE) {
  ...
  my_folds <- as.numeric(as.factor(train_eco))
    ...
    base::saveRDS(fit, paste0("../ModelFitting/models/yesOrNoTrees_Number1_globalLASSOmod_binomial_treeCutoff_",treeThreshold,".rds"))
...
## fit using betareg
  ...
  ## save models 
  saveRDS(fit_glm_bestLambda, paste0("./models/yesOrNoTrees_Number1_bestLambdaGLM_",treeThreshold,".rds"))
  saveRDS(fit_glm_halfse, paste0("./models/yesOrNoTrees_Number1_halfSELambdaGLM_",treeThreshold,".rds"))
  saveRDS(fit_glm_se, paste0("./models/yesOrNoTrees_Number1_oneSELambdaGLM_",treeThreshold,".rds"))
  ...
  save(f_glm_halfse, mat_glmnet_halfse, halfseLambda_coef,
              ...
              file = paste0("./models/interimModelFittingObjects_yesOrNoTrees_Number1_binomial_",treeThreshold,".rds"))
  } else {
    # read in LASSO object
    fit <- readRDS(paste0("../ModelFitting/models/yesOrNoTrees_Number1_globalLASSOmod_binomial_treeCutoff_",treeThreshold,".rds"))
    
    # read in R objects having to do w/ model fitting 
    load(file = paste0("./models/interimModelFittingObjects_yesOrNoTrees_Number1_binomial_",treeThreshold,".rds"))
      
  fit_glm_bestLambda <- readRDS(paste0("./models/yesOrNoTrees_Number1_bestLambdaGLM_",treeThreshold,".rds"))
  fit_glm_halfse <- readRDS(paste0("./models/yesOrNoTrees_Number1_halfSELambdaGLM_",treeThreshold,".rds"))
  fit_glm_se <- readRDS(paste0("./models/yesOrNoTrees_Number1_oneSELambdaGLM_",treeThreshold,".rds"))
  }
...
saveRDS(modDat_treePreds,"../../../Data_processed/CoverData/CoverModelData_Number1_withTreeNoTreePreds.rds")
```
