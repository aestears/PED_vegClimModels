...
The mean, area-weighted proportion of forest from the RAP data is 0.3133397
```{r}
...
plot(pred_glm1_w2w_cdf, xlab = c("P(Total Tree Cover)"), ylab = "Percentile",
     main = "Empirical Cumulative Distribution Function for \nUn-transformed model predictions of P(Forest) from the best-lambda model")
...
# plot the ecdf
plot(pred_glm1_w2w_cdf, xlab = c("P(Total Tree Cover)"), ylab = "Percentile",
     main = "Empirical Cumulative Distribution Function for \nUn-transformed model predictions of P(Forest) from the second best-lambda model")
abline(h = 0.3133397, lty = 2)
...
## Use the identified thresholds and 0-calibration points identified above to calibrate continuous and binary model predictions of forest probability
...
Make the continuous predictions binary
```{r}
## for test dataset
# best lambda model
# "binomialize" the continuous predictions
