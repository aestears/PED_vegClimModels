...
getModelStatement <- function(coefficientTable, # name of the d.f that has model coefficients
  ...
  temp[,modelName] <- round(temp[,modelName], 5)
...
tempNames <- str_replace_all(tempNames, pattern = "annWetDegDays_anom", 
                         replacement = paste0("((annWetDegDays_anom - ", 
                                              round(scaleParams$annWetDegDays_anom_s$`scaled:center`,5), ") / ", 
                                              round(scaleParams$annWetDegDays_anom_s$`scaled:scale`,5), ")"))

tempNames <- str_replace_all(tempNames, pattern = "prcpTempCorr_anom", 
                         replacement = paste0("((prcpTempCorr_anom - ", 
                                              round(scaleParams$prcpTempCorr_anom_s$`scaled:center`,5), ") / ", 
                                              round(scaleParams$prcpTempCorr_anom_s$`scaled:scale`,5), ")"))


tempNames <- str_replace_all(tempNames, pattern = "prcp_seasonality_anom", 
                         replacement = paste0("((prcp_seasonality_anom - ", 
                                              round(scaleParams$prcp_seasonality_anom_s$`scaled:center`,5), ") / ", 
                                              round(scaleParams$prcp_seasonality_anom_s$`scaled:scale`,5), ") "))

tempNames <- str_replace_all(tempNames, pattern = "annWatDef_anom", 
                         replacement = paste0("((annWatDef_anom - ", 
                                              round(scaleParams$annWatDef_anom_s$`scaled:center`,5), ") / ", 
                                              round(scaleParams$annWatDef_anom_s$`scaled:scale`,5), ") "))

tempNames <- str_replace_all(tempNames, pattern = "isothermality_anom", 
                         replacement = paste0("((isothermality_anom - ", 
                                              round(scaleParams$isothermality_anom_s$`scaled:center`,5), ") / ", 
                                              round(scaleParams$isothermality_anom_s$`scaled:scale`,5), ") "))

tempNames <- str_replace_all(tempNames, pattern = "prcp_anom", 
                         replacement = paste0("((prcp_anom - ", 
                                              round(scaleParams$prcp_anom_s$`scaled:center`,5), ") / ", 
                                              round(scaleParams$prcp_anom_s$`scaled:scale`,5), ") "))

tempNames <- str_replace_all(tempNames, pattern = "prcp ", 
                         replacement = paste0("((prcp - ", 
                                              round(scaleParams$prcp_s$`scaled:center`,5), ") / ", 
                                              round(scaleParams$prcp_s$`scaled:scale`,5), ") "))
...
tempNames <- str_replace_all(tempNames, pattern = "prcpTempCorr ", 
                         replacement = paste0("((prcpTempCorr - ", 
                                              round(scaleParams$prcpTempCorr_s$`scaled:center`,5), ") / ", 
                                              round(scaleParams$prcpTempCorr_s$`scaled:scale`,5), ") "))
...
tempNames <- str_replace_all(tempNames, pattern = "isothermality ", 
                         replacement = paste0("((isothermality - ", 
                                              round(scaleParams$isothermality_s$`scaled:center`,5), ") / ", 
                                              round(scaleParams$isothermality_s$`scaled:scale`,5), ") "))
...
tempNames <- str_replace_all(tempNames, pattern = "sand", 
                         replacement = paste0("((sand - ", 
                                              round(scaleParams$sand_s$`scaled:center`,5), ") / ", 
                                              round(scaleParams$sand_s$`scaled:scale`,5), ")"))

tempNames <- str_replace_all(tempNames, pattern = "coarse", 
                         replacement = paste0("((coarse - ", 
                                              round(scaleParams$coarse_s$`scaled:center`,5), ") / ", 
                                              round(scaleParams$coarse_s$`scaled:scale`,5), ")"))

tempNames <- str_replace_all(tempNames, pattern = "AWHC", 
                         replacement = paste0("((AWHC - ", 
                                              round(scaleParams$AWHC_s$`scaled:center`,5), ") / ", 
                                              round(scaleParams$AWHC_s$`scaled:scale`,5), ")"))

tempNames <- str_replace_all(tempNames, pattern = "carbon", 
                         replacement = paste0("((carbon - ", 
                                              round(scaleParams$carbon_s$`scaled:center`,5), ") / ", 
                                              round(scaleParams$carbon_s$`scaled:scale`,5), ")"))

tempNames <- str_replace_all(tempNames, pattern = "clay", 
                         replacement = paste0("((clay - ", 
                                              round(scaleParams$clay_s$`scaled:center`,5), ") / ", 
                                              round(scaleParams$clay_s$`scaled:scale`,5), ")"))

tempNames <- str_replace_all(tempNames, pattern = "annWatDef ", 
                         replacement = paste0("((annWatDef - ", 
                                              round(scaleParams$annWatDef_s$`scaled:center`,5), ") / ", 
                                              round(scaleParams$annWatDef_s$`scaled:scale`,5), ") "))
...
tempNames <- str_replace_all(tempNames, pattern = "prcp_seasonality ", 
                         replacement = paste0("((prcp_seasonality - ", 
                                              round(scaleParams$prcp_seasonality_s$`scaled:center`,5), ") / ", 
                                              round(scaleParams$prcp_seasonality_s$`scaled:scale`,5), ") "))
...
tempNames <- str_replace_all(tempNames, pattern = "tmean ", 
                         replacement = paste0("((tmean - ", 
                                              round(scaleParams$tmean_s$`scaled:center`,5), ") / ", 
                                              round(scaleParams$tmean_s$`scaled:scale`,5), ") "))
...
tempNames <- str_replace_all(tempNames, pattern = "annWetDegDays ", 
                         replacement = paste0("((annWetDegDays - ", 
                                              round(scaleParams$annWetDegDays_s$`scaled:center`,5), ") / ", 
                                              round(scaleParams$annWetDegDays_s$`scaled:scale`,5), ") "))
...
tempNames <- str_replace_all(tempNames, pattern = "prcp_dry ", 
                         replacement = paste0("((prcp_dry - ", 
                                              round(scaleParams$prcp_dry_s$`scaled:center`,5), ") / ", 
                                              round(scaleParams$prcp_dry_s$`scaled:scale`,5), ") "))
...
## Now, use the model to predict if a location is or is not trees, for all observations in the cover dataset (which we will use in the subsequent step of the cover-modelign process).
