...
kable(data.frame("Climate_And_Soils_Variables" = c(corrPlotNames_grassShrub[1:9],rep_len(NA,length.out = 5)), 
                 "Weather_Anomaly_Variables" = corrPlotNames_grassShrub[12:25]), format = 'html') %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed")) 
...
kable(data.frame("Climate_And_Soils_Variables" = c(corrPlotNamesForest[1:10],rep_len(NA,length.out = 6)), 
                 "Weather_Anomaly_Variables" = corrPlotNamesForest[12:27]), format = 'html') %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed")) 
