...
* 't_warm_anom' and 'VPD_max_95_anom': cor =  .72; chose 'VPD_max_95_anom'
* 't_cold_anom' and 'VPD_min_anom': cor =  .81; chose 'VPD_min_anom'
* 'frostFreeDays_anom' and 'frostFreeDays_5_anom': cor =  .73; chose 'frostFreeDays_5_anom'
* 'VPD_min_anom' and 'VPD_mean_anom': cor =  .71; chose 'VPD_mean_anom'
...
kable(data.frame("Climate_And_Soils_Variables" = c(corrPlotNames_conus[1:9],rep_len(NA,length.out = 4)), 
...
* 'tmean_anom' and 'tmax_anom': cor = .84; chose 'tmax_anom'
* 'VPD_max_anom' and 'VPD_max_95_anom': cor =  .80; chose 'VPD_max_95_anom'
* 'VPD_max_95_anom' and 't_warm_anom': cor =  .75; chose 't_warm_anom'
* 'annWatDef_95_anom' and 'annWatDef_anom': cor =  .81; chose 'annWatDef_anom'
* 't_cold_anom' and 'VPD_min_anom': cor =  .80; chose 'VPD_min_anom'
* 'prcp_anom' and 'prcp_wet_anom': cor =  .74; chose 'prcp_wet_anom'
* 'frostFreeDays_anom' and 'aboveFreezingMonth_anom': cor =  .80; chose 'aboveFreezingMonth_anom'
* remove annWetDegDays_5_anom because the distribution is very skewed
* remove annWatDef_95_anom because the distribution is very skewed (already removed, in this case)
...
kable(data.frame("Climate_And_Soils_Variables" = c(corrPlotNames_grassShrub[1:10],rep_len(NA,length.out = 4)), 
...
(corrPlot <- 
 ...
 # anomaly variables
   ...
   #t_cold_anom , #17
      prcp_wet_anom , #18
      precp_dry_anom , #19
    prcp_seasonality_anom , #20
     prcpTempCorr_anom , #21
      aboveFreezingMonth_anom , #22
    isothermality_anom , #23
       annWatDef_anom , #24
     annWetDegDays_anom , #25
      VPD_mean_anom , #26
      #VPD_min_anom , #27
      #VPD_max_anom , #28
     VPD_max_95_anom , #29
      #annWatDef_95_anom , #30
      #annWetDegDays_5_anom , #31
    frostFreeDays_5_anom , #32
      #frostFreeDays_anom  #33
   ) %>%
    #slice_sample(n = 5e3) %>% 
   cor()  %>% 
   caret::findCorrelation(cutoff = .7, verbose = TRUE, names = TRUE, exact = TRUE)) #%>% 
...
* 'VPD_max_anom' and 't_warm_anom': cor =  .88; chose 't_warm_anom'
* 't_warm_anom' and 'VPD_max_95_anom': cor =  .71; chose 'VPD_max_95_anom'
* 't_cold_anom' and 'VPD_min_anom': cor =  .81; chose 'VPD_min_anom'
* 'frostFreeDays_anom' and 'frostFreeDays_5_anom': cor =  .75; chose 'frostFreeDays_5_anom'
* 'VPD_min_anom' and 'VPD_mean_anom': cor =  .75; chose 'VPD_mean_anom'
* remove annWetDegDays_5_anom because the distribution is very skewed
* remove annWatDef_95_anom because the distribution is very skewed
...
kable(data.frame("Climate_And_Soils_Variables" = c(corrPlotNamesForest[1:11],rep_len(NA,length.out = 3)), 
                 "Weather_Anomaly_Variables" = corrPlotNamesForest[12:length(corrPlotNamesForest)]), format = 'html') %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed")) 
