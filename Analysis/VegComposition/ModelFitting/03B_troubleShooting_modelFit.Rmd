...
optimal_pred_betareg_byHand <- betareg:::predict.betareg(object = fit_glm_bestLambda_BETAREG_byHand, newdata = newdata_DF, type = "response")
optimal_pred_betareg_byHandSTAR <- betareg:::predict.betareg(object = fit_glm_bestLambda_BETAREG_byHandSTAR, newdata = newdata_DF, type = "response")
