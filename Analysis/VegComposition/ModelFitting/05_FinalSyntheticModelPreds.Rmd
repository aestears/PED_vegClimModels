...
approxfun_forest <- approxfun(x = c(0.136147,  0.4522613, 1), # values we're interpolating *from*
...
# Forest: best lambda model 
totalTree_F <- readRDS("./models/betaLASSO/TotalTreeCover_trees_noTLP_FALSE_removeAnomaliesTRUE_trimAnom_oneSELambdaGLM.rds")
...
# calculate GS and F forest cover by region, since we're using continuous probability of grassland * tree mod for non-forest, then binary probability * tree model for forest
contempPreds <- contempPreds %>% 
  mutate(absTotalTree_GS_scaled = prob_Forest_c * absTotalTree_F,
         absTotalTree_F_scaled = prob_Forest_b * absTotalTree_F) %>% 
  mutate(absTotalTree_GS_scaled = replace(absTotalTree_GS_scaled, prob_Forest_b == 1, 0),
         absTotalTree_F_scaled = replace(absTotalTree_F_scaled, prob_Forest_b == 0, 0))

contempPreds <- contempPreds %>% 
  mutate(#absTotalHerb_CONUS = (prob_grassShrub_c * absTotalHerb_GS) + (prob_Forest_c * absTotalHerb_F),
         absTotalTree_CONUS = absTotalTree_GS_scaled + absTotalTree_F_scaled#(prob_grassShrub_c * absTotalTree_GS) + (prob_Forest_b * absTotalTree_F)
         )
...
##AES
contempPreds <- contempPreds %>% 
    mutate(#percBLTree_scaled_GS = NA, #percBLTree_GS/(percBLTree_GS + percNLTree_GS),
         #percNLTree_scaled_GS = NA, #percNLTree_GS/(percBLTree_GS + percNLTree_GS),
         #percBLTree_scaled_F = percBLTree_F/(percBLTree_F + percNLTree_F),
         #percNLTree_scaled_F = percNLTree_F/(percBLTree_F + percNLTree_F),
        percBLTree_scaled_CONUS = percBLTree_CONUS/(percBLTree_CONUS + percNLTree_CONUS),
...
predsFuture1 <- predsFuture1  %>% 
    mutate(#percBLTree_scaled_GS = NA,#percBLTree_GS/(percBLTree_GS + percNLTree_GS),
         #ercNLTree_scaled_GS = NA,#percNLTree_GS/(percBLTree_GS + percNLTree_GS),
        percBLTree_scaled_CONUS = percBLTree_CONUS/(percBLTree_CONUS + percNLTree_CONUS),
          percNLTree_scaled_CONUS = percNLTree_CONUS/(percBLTree_CONUS + percNLTree_CONUS),
         percC3grass_scaled_CONUS = percC3grass_CONUS/(percC3grass_CONUS + percC4grass_CONUS + percForb_CONUS),
         percC4grass_scaled_CONUS = percC4grass_CONUS/(percC3grass_CONUS + percC4grass_CONUS + percForb_CONUS),
...
## for contemporary data
contempPreds <- contempPreds %>% 
    mutate(#absNLTree_GS = NA,#(percNLTree_scaled_GS * absTotalTree_GS), 
         # absBLTree_GS = NA,#(percBLTree_scaled_GS * absTotalTree_GS), 
         # absNLTree_F = (percNLTree_scaled_F * absTotalTree_F), 
         # absBLTree_F = (percBLTree_scaled_F * absTotalTree_F), 
         absNLTree_CONUS = (percNLTree_scaled_CONUS * absTotalTree_CONUS), 
...
```{r}
contempPreds <- contempPreds %>% 
  mutate(absBLTree_CONUS_scaled = absBLTree_CONUS,#prob_Forest_c * absBLTree_F,
         #absBLTree_F_scaled = prob_Forest_b * absBLTree_F,
         absNLTree_CONUS_scaled = absNLTree_CONUS#prob_Forest_c * absNLTree_F,
         #absNLTree_F_scaled = prob_Forest_b * absNLTree_F
         ) #%>% 
  # mutate(absBLTree_GS_scaled = replace(absBLTree_GS_scaled, prob_Forest_b == 1, 0),
  #        absNLTree_GS_scaled = replace(absNLTree_GS_scaled, prob_Forest_b == 1, 0),
  #        absBLTree_F_scaled = replace(absBLTree_F_scaled, prob_Forest_b == 0, 0),
  #        absNLTree_F_scaled = replace(absNLTree_F_scaled, prob_Forest_b == 0, 0))
# contempPreds <- contempPreds %>% 
#   mutate(absBLTree_CONUS = absBLTree_GS_scaled + absBLTree_F_scaled,
#          absNLTree_CONUS = absNLTree_GS_scaled + absNLTree_F_scaled#(prob_grassShrub_c * absTotalTree_GS) + (prob_Forest_b * absTotalTree_F)
#          )

#   mutate(absBLTree_CONUS = (prob_grassShrub * absBLTree_GS) + 
#            (prob_Forest * 
#              absBLTree_F),
#          absNLTree_CONUS = (prob_grassShrub * absNLTree_GS) + 
#            (prob_Forest * 
#              absNLTree_F)
#   )

# ggplot(contempPreds) +
#  geom_point(aes(x, y, col = absNLTree_F_scaled))
# ggplot(contempPreds) +
#  geom_point(aes(x, y, col = absNLTree_GS_scaled))
# ggplot(contempPreds) +
#  geom_point(aes(x, y, col = absNLTree_CONUS))
# ggplot(contempPreds) +
#  geom_point(aes(x, y, col = absTotalTree_CONUS - (absNLTree_CONUS + absBLTree_CONUS)))
...
```
```{r}
# plot(density(na.omit(contempPreds$absNLTree_CONUS + contempPreds$absBLTree_CONUS)), main = "absNLTree_CONUS + absBLTree_CONUS")
# plot(density(na.omit(contempPreds$absTotalTree_CONUS)), col = "green", main = "absTotalTree_CONUS")
```
...
preds_quantile <- preds_quantile %>%
    mutate(#absBLTree_GS_scaled = prob_Forest_c * absBLTree_F,
         absBLTree_CONUS_scaled = absBLTree_CONUS,
         #absNLTree_GS_scaled = prob_Forest_c * absNLTree_F,
...
# plot(density(na.omit(preds_quantile$absNLTree_CONUS + preds_quantile$absBLTree_CONUS)), main = "absNLTree_CONUS + absBLTree_CONUS")
# plot(density(na.omit(preds_quantile$absTotalTree_CONUS)), col = "green", main = "absTotalTree_CONUS")
# 
# 
# 
# # plot(density(na.omit(preds_quantile$ConifTreeCover_prop + preds_quantile$AngioTreeCover_prop)), main = "absNLTree_CONUS + absBLTree_CONUS")
# plot(density(na.omit(preds_quantile$NLTreeCover_abs + preds_quantile$BLTreeCover_abs)), main = "absNLTree_CONUS + absBLTree_CONUS")
# plot(density(na.omit(preds_quantile[!is.na(preds_quantile$NLTreeCover_abs),"TotalTreeCover"])), col = "green", main = "absTotalTree_CONUS")
```
...
predsOverTime <- predsOverTime %>%
    mutate(#absBLTree_GS_scaled = prob_Forest_c * absBLTree_F,
         absBLTree_CONUS_scaled = absBLTree_CONUS,#prob_Forest_b * absBLTree_F,
         #absNLTree_GS_scaled = prob_Forest_c * absNLTree_F,
         absNLTree_CONUS_scaled = absNLTree_CONUS#prob_Forest_b * absNLTree_F
         ) #%>% 
  # mutate(absBLTree_GS_scaled = replace(absBLTree_GS_scaled, prob_Forest_b == 1, 0),
  #        absNLTree_GS_scaled = replace(absNLTree_GS_scaled, prob_Forest_b == 1, 0),
  #        absBLTree_F_scaled = replace(absBLTree_F_scaled, prob_Forest_b == 0, 0),
  #        absNLTree_F_scaled = replace(absNLTree_F_scaled, prob_Forest_b == 0, 0))
predsOverTime <- predsOverTime %>% 
  mutate(absBLTree_CONUS = absBLTree_CONUS_scaled, #+ absBLTree_F_scaled,
         absNLTree_CONUS = absNLTree_CONUS_scaled #+ absNLTree_F_scaled#(prob_grassShrub_c * absTotalTree_GS) + (prob_Forest_b * absTotalTree_F)
         )
...
#          absTotalTree_CONUS = (prob_grassShrub * absTotalTree_GS) + 
#            (prob_Forest * 
#              absTotalTree_F)
#          )
# 
