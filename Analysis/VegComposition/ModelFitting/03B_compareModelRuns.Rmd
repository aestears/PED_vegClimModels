...
forecastClimSoilsDat_1 <- climDat %>% 
...
# add soils to climate data
forecastClimSoilsDat_2 <- climDat %>% 
  cbind(soils_final, by = c("x", "y"))
...
forecastClimSoilsDat_1 <- forecastClimSoilsDat_1[,-c(90,91)]
# rename
...
forecastClimSoilsDat_2 <- forecastClimSoilsDat_2[,-c(90,91)]
# rename
