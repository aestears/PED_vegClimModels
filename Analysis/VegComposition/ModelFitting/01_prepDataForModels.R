...
modDat[(modDat$HerbCover_dec==1 | (modDat$HerbCover_dec>1 & modDat$HerbCover_dec<1.5)) & !is.na(modDat$HerbCover), "HerbCover_dec"] <- .999 
modDat[(modDat$TotalGramCover_dec==1 | (modDat$TotalGramCover_dec>1 & modDat$TotalGramCover_dec<1.5)) & !is.na(modDat$TotalGramCover), "TotalGramCover_dec"] <- .999 
modDat[(modDat$C3GramCover_dec==1 | (modDat$C3GramCover_dec>1 & modDat$C3GramCover_dec<1.5)) & !is.na(modDat$C3GramCover), "C3GramCover_dec"] <- .999 
