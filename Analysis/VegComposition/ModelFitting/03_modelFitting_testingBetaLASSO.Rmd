...
for (i in 1:length(names(coefficients(fit_glm_bestLambda)[-1]))) {
  pd_bestLambda_i <- pdp::partial(object = fit_glm_bestLambda, pred.var = names(coefficients(fit_glm_bestLambda)[-1])[i], train = pred_glm1, type = "regression")
...
for (i in 1:length(prednames_secondBestMod)) {
  pd_secondBestLambda_i <- pdp::partial(object = mod_secondBest, pred.var = prednames_secondBestMod[i], train = pred_glm1_1se, type = "regression")
