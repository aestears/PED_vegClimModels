...
params:
  run: FALSE     
  save_figs: TRUE
  ecoregion: trees # trees or noTrees
  response: TotalTreeCover
  allowAllTreeData: FALSE
...
```
### Subset the data to only include data for the ecoregion of interest based on whether or not the location is forested (i.e. total tree cover is >10%) 
...
```{r model evaluation figures, eval=FALSE}
 
# # lasso model predictions with the optimal lambda
# x <- quasibeta_family()
# 
#   pred_rawLASSO <- x[["linkinv"]](glmnet::predict.glmnet(object = fit$glmnet.fit, newx = X[,2:ncol(X)], s = best_lambda)  )
#   pred_rawLASSO_link <- glmnet::predict.glmnet(object = fit$glmnet.fit, newx = X[,2:ncol(X)], s = best_lambda, type = "link")
#   # predictions by hand 
#   predVector <- fit$glmnet.fit$beta[,fit$index["min",]]
#   pred_rawLASSO_byHand_link <- c(fit$glmnet.fit$a0[fit$index["min",]] + 
#                                    predVector[1] * X[,names(predVector[1])] + predVector[2] * X[,names(predVector[2])] + predVector[3] * X[,names(predVector[3])] + predVector[4] * X[,names(predVector[4])] + predVector[5] * X[,names(predVector[5])] + predVector[6] * X[,names(predVector[6])] + predVector[7] * X[,names(predVector[7])] + predVector[8] * X[,names(predVector[8])] + predVector[9] * X[,names(predVector[9])] + predVector[10] * X[,names(predVector[10])] + predVector[11] * X[,names(predVector[11])] + predVector[12] * X[,names(predVector[12])] + predVector[13] * X[,names(predVector[13])] + predVector[14] * X[,names(predVector[14])] + predVector[15] * X[,names(predVector[15])] + predVector[16] * X[,names(predVector[16])] + predVector[17] * X[,names(predVector[17])] + predVector[18] * X[,names(predVector[18])] + predVector[19] * X[,names(predVector[19])] + predVector[20] * X[,names(predVector[20])] + predVector[21] * X[,names(predVector[21])] + predVector[22] * X[,names(predVector[22])] + predVector[23] * X[,names(predVector[23])] + predVector[24] * X[,names(predVector[24])] + predVector[25] * X[,names(predVector[25])] + predVector[26] * X[,names(predVector[26])] + predVector[27] * X[,names(predVector[27])] + predVector[28] * X[,names(predVector[28])] + predVector[29] * X[,names(predVector[29])] + predVector[30] * X[,names(predVector[30])] +  predVector[31] * X[,names(predVector[31])] + predVector[32] * X[,names(predVector[32])] + predVector[33] * X[,names(predVector[33])] + predVector[34] * X[,names(predVector[34])] + predVector[35] * X[,names(predVector[35])] + predVector[36] * X[,names(predVector[36])] + predVector[37] * X[,names(predVector[37])] + predVector[38] * X[,names(predVector[38])] + predVector[39] * X[,names(predVector[39])] +predVector[40] * X[,names(predVector[40])] + predVector[41] * X[,names(predVector[41])] + predVector[42] * X[,names(predVector[42])] + predVector[43] * X[,names(predVector[43])] + predVector[44] * X[,names(predVector[44])] + predVector[45] * X[,names(predVector[45])] + predVector[46] * X[,names(predVector[46])] + predVector[47] * X[,names(predVector[47])] + predVector[48] * X[,names(predVector[48])] + predVector[49] * X[,names(predVector[49])] +predVector[50] * X[,names(predVector[50])] + predVector[51] * X[,names(predVector[51])] + predVector[52] * X[,names(predVector[52])] + predVector[53] * X[,names(predVector[53])] + predVector[54] * X[,names(predVector[54])] + predVector[55] * X[,names(predVector[55])] + predVector[56] * X[,names(predVector[56])] + predVector[57] * X[,names(predVector[57])] + predVector[58] * X[,names(predVector[58])] + predVector[59] * X[,names(predVector[59])] +predVector[60] * X[,names(predVector[60])] + predVector[61] * X[,names(predVector[61])] + predVector[62] * X[,names(predVector[62])] + predVector[63] * X[,names(predVector[63])] + predVector[64] * X[,names(predVector[64])] + predVector[65] * X[,names(predVector[65])] + predVector[66] * X[,names(predVector[66])] + predVector[67] * X[,names(predVector[67])] + predVector[68] * X[,names(predVector[68])] + predVector[69] * X[,names(predVector[69])] +predVector[70] * X[,names(predVector[70])] + predVector[71] * X[,names(predVector[71])] + predVector[72] * X[,names(predVector[72])] + predVector[73] * X[,names(predVector[73])] + predVector[74] * X[,names(predVector[74])] + predVector[75] * X[,names(predVector[75])] + predVector[76] * X[,names(predVector[76])] + predVector[77] * X[,names(predVector[77])] + predVector[78] * X[,names(predVector[78])] + predVector[79] * X[,names(predVector[79])] +predVector[80] * X[,names(predVector[80])] + predVector[81] * X[,names(predVector[81])] + predVector[82] * X[,names(predVector[82])] + predVector[83] * X[,names(predVector[83])] + predVector[84] * X[,names(predVector[84])] + predVector[85] * X[,names(predVector[85])] + predVector[86] * X[,names(predVector[86])] + predVector[87] * X[,names(predVector[87])] + predVector[88] * X[,names(predVector[88])] + predVector[89] * X[,names(predVector[89])] +predVector[90] * X[,names(predVector[90])] + predVector[91] * X[,names(predVector[91])] + predVector[92] * X[,names(predVector[92])] + predVector[93] * X[,names(predVector[93])] + predVector[94] * X[,names(predVector[94])] + 
#                                    predVector[95] * X[,names(predVector[95])] + predVector[96] * X[,names(predVector[96])] + predVector[97] * X[,names(predVector[97])] + predVector[98] * X[,names(predVector[98])] + predVector[99] * X[,names(predVector[99])] +predVector[100] * X[,names(predVector[100])] + predVector[101] * X[,names(predVector[101])] + predVector[102] * X[,names(predVector[102])] + predVector[103] * X[,names(predVector[103])] + predVector[104] * X[,names(predVector[104])] + predVector[105] * X[,names(predVector[105])] + predVector[106] * X[,names(predVector[106])] + predVector[107] * X[,names(predVector[107])] + predVector[108] * X[,names(predVector[108])] + predVector[109] * X[,names(predVector[109])] +predVector[110] * X[,names(predVector[110])] + predVector[111] * X[,names(predVector[111])] + predVector[112] * X[,names(predVector[112])] + predVector[113] * X[,names(predVector[113])] + predVector[114] * X[,names(predVector[114])] + predVector[115] * X[,names(predVector[115])] + predVector[116] * X[,names(predVector[116])] + predVector[117] * X[,names(predVector[117])] + predVector[118] * X[,names(predVector[118])] + predVector[119] * X[,names(predVector[119])] +predVector[120] * X[,names(predVector[120])] + predVector[121] * X[,names(predVector[121])] + predVector[122] * X[,names(predVector[122])] + predVector[123] * X[,names(predVector[123])] + predVector[124] * X[,names(predVector[124])] + predVector[125] * X[,names(predVector[125])] + predVector[126] * X[,names(predVector[126])] + predVector[127] * X[,names(predVector[127])] + predVector[128] * X[,names(predVector[128])] + predVector[129] * X[,names(predVector[129])] +predVector[130] * X[,names(predVector[130])] + predVector[131] * X[,names(predVector[131])] + predVector[132] * X[,names(predVector[132])] + predVector[133] * X[,names(predVector[133])] + predVector[134] * X[,names(predVector[134])] + predVector[135] * X[,names(predVector[135])] + predVector[136] * X[,names(predVector[136])] + predVector[137] * X[,names(predVector[137])] + predVector[138] * X[,names(predVector[138])] + predVector[139] * X[,names(predVector[139])] +predVector[140] * X[,names(predVector[140])] + predVector[141] * X[,names(predVector[141])] + predVector[142] * X[,names(predVector[142])] + predVector[143] * X[,names(predVector[143])] + predVector[144] * X[,names(predVector[144])] + predVector[145] * X[,names(predVector[145])] + predVector[146] * X[,names(predVector[146])] + predVector[147] * X[,names(predVector[147])] + predVector[148] * X[,names(predVector[148])] + predVector[149] * X[,names(predVector[149])] 
#   )
#   
#   # transform to the scale of the response by hand 
#   pred_rawLASSO_byHand <- exp(pred_rawLASSO_byHand_link)/(1 + exp(pred_rawLASSO_byHand_link))
#   
#   
#   plot(density(pred_rawLASSO), col = "red", xlim = c(-2, 2), 
#        main = "predictions from LASSO model (prior to stability selection, trim anoms, etc.) \ngreen = preds. on the logit-link scale, \nred = preds. on the response scale; black = observations", 
#        )
#   lines(density(pred_rawLASSO_link), col = "green")
#   lines(density(y), col = "black")
#   lines(density( pred_rawLASSO_byHand_link), col = "darkgreen")
#   lines(density( pred_rawLASSO_byHand), col = "brown")
#   #lines(density(y), col = "black")
#   
# plot(density(fullModOut$modelPredictions$obs), 
#      ylim = c(0,4), 
#      main = c("black = observed values \n red = predictions from 'best lambda' model with quasi-beta \n blue = predictions from 'best lambda' model with betareg()")) #\n orange = predictions for '1/2se' lambda model \n green = predictions from '1se' lambda model "))
# lines(density(fullModOut$modelPredictions$pred_opt), col = "red")
# #lines(density(optimal_pred_betareg), col = "blue")
# 
# #lines(density(optimal_pred_ByHand), col = "red", lty = 2)
# lines(density(fullModOut$modelPredictions$pred_opt_halfse), col = "orange")
# lines(density(fullModOut$modelPredictions$pred_opt_se), col = "green")
# #lines(density(fullModOut$modelPredictions$pred_null), col = "blue")
```
...
### Calibrate so that the model is predicting no trees in the appropriate locations (only run for total tree cover in unforested locations)
```{r}
...
# now, rasterize on the dayMet grid
climDatPred_ecoregion_rast <- climDatPred_ecoregion %>%
  st_as_sf(coords = c("Lon", "Lat"), crs = crs("PROJCRS[\"unnamed\",\n    BASEGEOGCRS[\"unknown\",\n        DATUM[\"unknown\",\n            ELLIPSOID[\"Spheroid\",6378137,298.257223563,\n                LENGTHUNIT[\"metre\",1,\n                    ID[\"EPSG\",9001]]]],\n        PRIMEM[\"Greenwich\",0,\n            ANGLEUNIT[\"degree\",0.0174532925199433,\n                ID[\"EPSG\",9122]]]],\n    CONVERSION[\"Lambert Conic Conformal (2SP)\",\n        METHOD[\"Lambert Conic Conformal (2SP)\",\n            ID[\"EPSG\",9802]],\n        PARAMETER[\"Latitude of false origin\",42.5,\n            ANGLEUNIT[\"degree\",0.0174532925199433],\n            ID[\"EPSG\",8821]],\n        PARAMETER[\"Longitude of false origin\",-100,\n            ANGLEUNIT[\"degree\",0.0174532925199433],\n            ID[\"EPSG\",8822]],\n        PARAMETER[\"Latitude of 1st standard parallel\",25,\n            ANGLEUNIT[\"degree\",0.0174532925199433],\n            ID[\"EPSG\",8823]],\n        PARAMETER[\"Latitude of 2nd standard parallel\",60,\n            ANGLEUNIT[\"degree\",0.0174532925199433],\n            ID[\"EPSG\",8824]],\n        PARAMETER[\"Easting at false origin\",0,\n            LENGTHUNIT[\"metre\",1],\n            ID[\"EPSG\",8826]],\n        PARAMETER[\"Northing at false origin\",0,\n            LENGTHUNIT[\"metre\",1],\n            ID[\"EPSG\",8827]]],\n    CS[Cartesian,2],\n        AXIS[\"easting\",east,\n            ORDER[1],\n            LENGTHUNIT[\"metre\",1,\n                ID[\"EPSG\",9001]]],\n        AXIS[\"northing\",north,\n            ORDER[2],\n            LENGTHUNIT[\"metre\",1,\n                ID[\"EPSG\",9001]]]]")) %>%
  terra::vect() %>%
  terra::rasterize(y = test_rast_dayMet_TEMP, field = "ForestPred_binary")

cropped_states2 <- cropped_states %>% 
  sf::st_transform(crs(test_rast_dayMet_TEMP))

### perform following steps only for total tree cover in unforested locations
if (response == "TotalTreeCover_transformed" & ecoregion == "noTrees") {
  

###Get data that shows un-forested locations, based on RAP. This dataset is created by first identifying RAP 30-m pixels that have 5% or less of tree cover. Then that information is aggregated up to the dayMet scale, and the value provided is the percentage of RAP pixels within a given dayMet grid cell that have <5% tree cover. 
## get RAP unforested cover dataset from Martin
  #RAP_v3_fracNotForest_lt5_mask-lcmap50_2019-2023_1000m.tif
  #
...
## mask this raster to the same extent as the unforested locations identified above
notForest_rast_mask <- nonForest_rast %>% 
  terra::mask(mask = climDatPred_ecoregion_rast %>% crop(y = nonForest_rast))

## then, mask the unforested raster above w/ the resulting RAP unforested raster, to make sure that the masks we're using to remove developed and burned areas are the same across rasters
climDatPred_ecoregion_rast_mask <- climDatPred_ecoregion_rast %>% 
  crop(y = nonForest_rast) %>% 
  terra::mask(mask = notForest_rast_mask)

## now, turn the information about these locations back into points 

# pointsToUse_Terra <- terra::as.points(climDatPred_ecoregion_rast_mask) %>% 
#   st_as_sf()

climDatPred_pointsUse <- climDatPred_ecoregion_rast_mask %>% 
  terra::extract(y = climDatPred_ecoregion %>% terra::vect() , 
                 bind = TRUE, 
                 method = "simple",
                 xy = TRUE)

 climDatPred_pointsUse_2 <- climDatPred_pointsUse %>% 
   filter(!is.na(last)) %>% 
   select(-x, -y)

 #crs(climDatPred_ecoregion_rast_mask) == crs(climDatPred_pointsUse_2)

climDatPred_pointsUse_2_noSF <- climDatPred_pointsUse_2 %>% 
  as.data.frame()

## with the above data, use the tree cover model to predict tree cover for these locations
# predict 
climPred_totalTree <- predict_by_response(fit_glm_bestLambda, climDatPred_pointsUse_2_noSF#X[,2:ncol(X)]
                                 )
# now, back-transform the predictions (divide by 10)
climPred_totalTree <- climPred_totalTree %>% 
  mutate(TotalTreeCover_pred = TotalTreeCover_transformed_pred)

 # ggplot(climPred_totalTree) + 
 #   geom_point(aes(x = Lon, y = Lat, col = TotalTreeCover_pred))
 #   
 
## identify the area-weighted proportion of masked RAP forested data that is unforested
# area of each pixel in m² (accounts for projection distortion)
pixel_area <- cellSize(notForest_rast_mask, unit = "m")

# # total non-forest area (m² → km²)
# area_not_forest_m2 <- global(notForest_rast_mask * pixel_area, fun = "sum", na.rm = TRUE)
...
# mean_frac_nonForest_fromRAP <- global(notForest_rast_mask * pixel_area, fun = "sum", na.rm = TRUE)$sum /
#   global(pixel_area * !is.na(notForest_rast_mask), fun = "sum", na.rm = TRUE)$sum

# classify the nonForest rast into 1/0 (anything >= .5 = 1 and < 0.5 = 0)
notForest_rast_mask_round <- round(notForest_rast_mask)
# version w/ rounded nonForest raster
mean_frac_nonForest_fromRAP <- global(notForest_rast_mask_round * pixel_area, fun = "sum", na.rm = TRUE)$sum /
  global(pixel_area * !is.na(notForest_rast_mask_round), fun = "sum", na.rm = TRUE)$sum

## identify a threshold for the predictions of total trees that gives us the amount of 0% tree locations that we want 
# make an empirical cumulative probability function plot of the model predictions on wall-to-wall data
  climPred_totalTree_cdf <- stats::ecdf(climPred_totalTree$TotalTreeCover_transformed_pred)
# find the quantile of observations that corresponds to the desired proportion of unforested locations
zeroCutoff <- quantile(climPred_totalTree$TotalTreeCover_transformed_pred %>% na.omit(), probs = mean_frac_nonForest_fromRAP) 
# save zeroCutoff
saveRDS(zeroCutoff, "./models/TotalTreeCoverInNonForest_zeroCutoff.rds")
# plot the ecdf
plot(climPred_totalTree_cdf, xlab = c("% Total Tree Cover"), ylab = "Percentile",
     main = "Empirical Cumulative Distribution Function for \n model predictions of Total Tree Cover in non-forested \nregions from the best-lambda model")
abline(h = mean_frac_nonForest_fromRAP, lty = 3)
abline(v = zeroCutoff, lty = 3)

# ## now, interpolate the model predictions such that the predictions of total tree cover below the threshold are forced to 0
# approxfun <- approxfun(x = c(0,  zeroCutoff, 0.1), # values we're interpolating *from*
#           y =c(0, 0, 0.1), # what we're interpolation to (desired values at the end)
#           method = "linear")

## force all values below the cutoff to be zero, but leave all values above the cutoff as is
# interpolate the predictions
climPred_totalTree <- climPred_totalTree %>% 
  mutate(#TotalTreeCover_interp = approxfun(TotalTreeCover_pred)
    TotalTreeCover_interp = TotalTreeCover_pred, 
    TotalTreeCover_interp = replace(TotalTreeCover_interp, TotalTreeCover_interp<=zeroCutoff, 0))
# ggplot(climPred_totalTree) +
#   geom_point(aes(Lon, Lat, col = TotalTreeCover_interp), size = 1) + 
#   geom_point(data = climPred_totalTree[climPred_totalTree$TotalTreeCover_interp == 0,],
#              aes(Lon, Lat), size = 1, col = "red")
# rasterize the interpolated predictions
}
```

Interpolate the model predictions and back-transform the observations, if necessary
```{r}
if(response == "TotalTreeCover_transformed") {
  # apply the zero cutoff
pred_glm1 <- pred_glm1 %>% 
  mutate(
    TotalTreeCover_transformed_pred = replace(TotalTreeCover_transformed_pred, TotalTreeCover_transformed_pred<=zeroCutoff, 0))

#  pred_glm1$TotalTreeCover_transformed_pred <-  approxfun(pred_glm1$TotalTreeCover_transformed_pred)
  
   # apply the zero cutoff
  #pred_glm1_1se$TotalTreeCover_transformed_pred <- approxfun(pred_glm1_1se$TotalTreeCover_transformed_pred)
  pred_glm1_1se <- pred_glm1_1se %>% 
  mutate(
    TotalTreeCover_transformed_pred = replace(TotalTreeCover_transformed_pred, TotalTreeCover_transformed_pred<=zeroCutoff, 0))
...
```
```{r Relative Residual map from best lambda model, fig.height = 12, fig.width = 9, warning = FALSE }
...
```{r Absolute Residual map from 1 SE lambda model, fig.height = 12, fig.width = 9, warning = FALSE }
if ( name_secondBestMod == "Intercept_Only") {
  print("The next best lambda model only contains one predictor (an intercept)")
} else {
...
if (ecoregion == "noTrees" & response == "TotalTreeCover_transformed") {
  ## now, apply cutoff for zeros
climDatPred_ecoregion_glm1 <- climDatPred_ecoregion_glm1 %>% 
  mutate(TotalTreeCover_transformed_pred = replace(TotalTreeCover_transformed_pred, TotalTreeCover_transformed_pred<=zeroCutoff, 0))

# now, rasterize the pr
}
...
if (ecoregion == "noTrees" & response == "TotalTreeCover_transformed") {
## now, do interpolation step 
climDatPred_ecoregion_glm1_1se <- climDatPred_ecoregion_glm1_1se %>% 
 mutate(TotalTreeCover_transformed_pred = replace(TotalTreeCover_transformed_pred, TotalTreeCover_transformed_pred<=zeroCutoff, 0)) 
}
...
testDat_DF <- data.frame(X[test,2:ncol(X)])
