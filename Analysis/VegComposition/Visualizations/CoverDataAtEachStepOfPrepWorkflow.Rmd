...
dat_3_temp[is.finite(dat_3_temp$AngioTreeCover_prop) & is.na(dat_3_temp$TotalTreeCover),]
  ...
  ggplot() + 
    ...
    geom_density(data = dat_3_temp, aes(TotalTreeCover, col = Source)) + 
    geom_density(data = dat_3_temp[is.finite(dat_3_temp$AngioTreeCover_prop),], aes(TotalTreeCover, col = Source),lty = 2) + 
